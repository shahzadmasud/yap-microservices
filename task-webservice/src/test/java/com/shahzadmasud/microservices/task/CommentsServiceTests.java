package com.shahzadmasud.microservices.task;
...
import com.shahzadmasud.microservices.task.apis.CommentsService;
import com.shahzadmasud.microservices.task.model.CommentCollectionResource;
import com.shahzadmasud.microservices.task.oauth2.config.OAuth2ClientTestConfiguration;
import com.shahzadmasud.microservices.task.oauth2.security.WithMockOAuth2Token;
...
@AutoConfigureStubRunner(ids = { "shahzadmasud:basic-comments-webservice-stubs:+:stubs:9083" }, workOffline = true)
@DirtiesContext
