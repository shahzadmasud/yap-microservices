package com.shahzadmasud.microservices.user.api;
...
import com.shahzadmasud.microservices.user.dto.UserDTO;
...
public class UserController {
	...
	private List<UserDTO> users = Arrays.asList(new UserDTO("Shahzad", "Masud", "1", "shahzad.masud@" + mailDomain),
